							...
							<div class="text-center mx-auto">
								...
								<script>
									function cerrarSesion() {
										// Redireccionar a la pÃƒÂ¡gina de inicio de sesiÃƒÂ³n
											...
											<div class="col-sm-4">
												<select class="form-select" id="search_field"
													...
													<option value="names_last_names" selected>Nombres
														y apellidos</option>
													<option value="number_document">Nº de documento</option>
												</select>
											</div>
											<div class="col-sm-1">
							...
							<div class="card" id="divRegistro" style="display: none;">
								...
								<div class="card-body">
									<form>
										...
										<div class="row mb-3">
											...
											<div class="col-sm-10">
												<input type="text" class="form-control" id="frmNames"
													...
													pattern="[A-Za-zÃ¡Ã©Ã­Ã³ÃºÃÃ‰ÃÃ“Ãš\s]+">
											...
											apellidosInput
													.addEventListener(
															...
															function(event) {
																...
																// ExpresiÃ³n regular para validar solo letras y espacios
																var regex = /^[A-Za-z\s]+$/;
										...
										<script>
											// Obtener el campo de entrada de correo electrÃ³nico
											...
											emailInput
													.addEventListener(
															'input',
															function(event) {
																// Validar si el correo electrÃ³nico es vÃ¡lido
																if (emailInput
																		.checkValidity()) {
										...
										<script>
											...
											documentTypeInput
													.addEventListener(
															'input',
															function(event) {
																// Validar si se ha seleccionado una opciÃ³n
...
.btn.btn-outline-success.mb-1:hover {
	...
	<script>
		...
		function fnBtnProcesar() {
			...
			xhr.onreadystatechange = function() {
				if (xhr.readyState === 4 && xhr.status === 200) {
					// La solicitud se completÃƒÂ³ correctamente
					console.log(xhr.responseText);
					alert(xhr.responseText);

					// Redireccionar a la pÃ¡gina de registros
		...
		function fnBtnBuscar() {
			...
			// Obtener valores adicionales segÃºn la opciÃ³n seleccionada en el campo de bÃºsqueda
		...
		function listar(status) {
			...
			xhttp.onreadystatechange = function() {
				if (this.readyState == 4 && this.status == 200) {
					...
					// Mostrar/ocultar elementos segÃºn sea necesario
					document.getElementById("divResultado").style.display = "block";
					document.getElementById("divRegistro").style.display = "none";
				}
			};
